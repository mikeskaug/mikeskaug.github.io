/* @pjs preload="human_kitchen_trajs.svg, ../icons/plus_button.jpg, ../icons/minus_button.jpg"; */ //*********************************************
PShape trajs;
ScaleBar scale;
...
String mover = "Feet in the Kitchen";  //*********************************************
PFont f;
...
void setup() 
{
  ...
  trajs = loadShape("human_kitchen_trajs.svg");  //*********************************************
  trajs.disableStyle();
  imgW = trajs.width;
  imgH = trajs.height;
