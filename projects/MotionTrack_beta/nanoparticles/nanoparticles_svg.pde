/* @pjs preload="nanoparticles_trajs.svg, ../icons/plus_button.jpg, ../icons/minus_button.jpg"; */
PShape trajs;
ScaleBar scale;
...
String mover = "Particles in Microscopic Pores";  //*********************************************
PFont f;
...
void setup() 
{
  ...
  trajs = loadShape("nanoparticles_trajs.svg");
  trajs.disableStyle();
  imgW = trajs.width;
  imgH = trajs.height;
