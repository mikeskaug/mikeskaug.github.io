/* @pjs preload="quinoa_trajs.svg, ../icons/plus_button.jpg, ../icons/minus_button.jpg"; */ //*********************************************
PShape trajs;
ScaleBar scale;
...
void setup() 
{
  ...
  trajs = loadShape("quinoa_trajs.svg");  //*********************************************
  trajs.disableStyle();
  imgW = trajs.width;
  imgH = trajs.height;
