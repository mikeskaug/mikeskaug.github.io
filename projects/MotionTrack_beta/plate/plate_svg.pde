/* @pjs preload="plate_traj.svg, ../icons/plus_button.jpg, ../icons/minus_button.jpg"; */ //*********************************************
PShape trajs;
ScaleBar scale;
...
void setup() 
{
  ...
  trajs = loadShape("plate_traj.svg");  //*********************************************
  trajs.disableStyle();
  imgW = trajs.width;
  imgH = trajs.height;
