...
void setup()
{
  ...
  int y_min = -9;
  int y_max = 6;
  x_axis = new xAxis("Seconds",x_min,x_max,19);
  y_axis = new yAxis("Meters",y_min,y_max,17);
  ...
  icons[0] = new Icons("frogs",770,190,20,"frogs/frogs_index.html", frogs_big);
  
  PImage nanoparticle_big;
  nanoparticle_big = loadImage("icons/nanoparticle_icon_big.jpg");
  icons[1] = new Icons("nanoparticles",480,520,20,"nanoparticles/nanoparticles_index.html",nanoparticle_big);
  
  PImage osprey_big;
  osprey_big = loadImage("icons/osprey_icon_big.jpg");
  icons[2] = new Icons("osprey",770,70,20,"osprey/osprey_index.html",osprey_big);
  
  PImage plate_big;
  plate_big = loadImage("icons/plate_icon_big.png");
  icons[3] = new Icons("Earth Surface",840,380,20,"plate/plate_index.html",plate_big);
  
  PImage sheep_dog_big;
  sheep_dog_big = loadImage("icons/sheep_dog_icon_big.jpg");
  icons[4] = new Icons("Sheep Dogs",800,140,20,"sheep_dogs/sheep_dogs_index.html",sheep_dog_big);
  
  PImage elephants_big;
  elephants_big = loadImage("icons/elephants_icon_big.jpg");
  icons[5] = new Icons("Elephants",820,100,20,"elephants/elephants_index.html",elephants_big);
  
  PImage bouys_big;
  bouys_big = loadImage("icons/bouys_icon_big.jpg");
  icons[6] = new Icons("Ocean Bouys",810,70,20,"bouys/bouys_index.html",bouys_big);
  
  PImage quinoa_big;
  quinoa_big = loadImage("icons/quinoa_icon_big.jpg");
  icons[7] = new Icons("Floating Quinoa",510,350,20,"quinoa/quinoa_index.html",quinoa_big);
  
  PImage human_kitchen_big;
  human_kitchen_big = loadImage("icons/human_kitchen_icon_big.jpg");
  icons[8] = new Icons("Kitchen Feet",550,300,20,"human_kitchen/human_kitchen_index.html",human_kitchen_big);
...
class Icons{
  ...
  Icons(String _label, int _pos_x, int _pos_y, int _size, String _url, PShape _icon_big){
    label = _label;
    pos_x = _pos_x;
    pos_y = _pos_y;
    size = _size;
