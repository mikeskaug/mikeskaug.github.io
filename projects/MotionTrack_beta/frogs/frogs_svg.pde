/* @pjs preload="frog_trajs.svg, ../icons/plus_button.jpg, ../icons/minus_button.jpg"; */
PShape trajs;
ScaleBar scale;
...
void setup() 
{
  ...
  //initialize scale bar supplying pixels/meter convertion factor, here it is 0.00288 pixels/meter from 111034 meters/degree
  scale = new ScaleBar(0.00288);  //*********************************************
